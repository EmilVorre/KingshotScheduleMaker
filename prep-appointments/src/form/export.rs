...
pub fn export_submission_to_csv(
    ...
    let construction_time_strings: Vec<String> = submission
    ...
    let research_time_strings: Vec<String> = submission
        .research_time_slots
        .iter()
        .filter_map(|&slot| {
            research_slots
    ...
    let troops_time_strings: Vec<String> = submission
        .troops_time_slots
        .iter()
        .filter_map(|&slot| {
            troops_slots
    ...
    let construction_yes_no = if submission.wants_construction {
        "Yes"
    } else {
        "No"
    };
    let research_yes_no = if submission.wants_research {
        "Yes"
    } else {
        "No"
    };
    ...
    let construction_speedups_str = submission
        .construction_speedups
        .map(|v| v.to_string())
        .unwrap_or_default();
    let construction_truegold_str = submission
        .construction_truegold
        .map(|v| v.to_string())
        .unwrap_or_default();
    let construction_tempered_truegold_str = submission
        .construction_tempered_truegold
        .map(|v| v.to_string())
        .unwrap_or_default();
    let research_speedups_str = submission
        .research_speedups
        .map(|v| v.to_string())
        .unwrap_or_default();
    let research_truegold_dust_str = submission
        .research_truegold_dust
        .map(|v| v.to_string())
        .unwrap_or_default();
    let troops_speedups_str = submission
        .troops_speedups
        .map(|v| v.to_string())
        .unwrap_or_default();
    ...
    wtr.write_record(&[
        ...
        &construction_tempered_truegold_str,
